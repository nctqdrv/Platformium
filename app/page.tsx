      ...
      for (const row of excelData) {
        try {
          ...
          const dataToInsert = {
            ...
            subscribers: parseInt(row.Subscribers) || null,
            demography: row.Demography || null,
            age: row.Age || null,
            source: row.Source || null,
            publication_place: row["Publication place"] || null,
            publication_place_subscribers: parseInt(row["Publication place subscribers"]) || null,
            ...
            reactions: parseInt(row.Reactions) || null,
            engagement: parseInt(row.Engagement) || null,
            likes: parseInt(row.Likes) || null,
            love: parseInt(row.Love) || null,
            haha: parseInt(row.Haha) || null,
            wow: parseInt(row.Wow) || null,
            sad: parseInt(row.Sad) || null,
            angry: parseInt(row.Angry) || null,
            care: parseInt(row.Care) || null,
            dislikes: parseInt(row.Dislikes) || null,
            comments: parseInt(row.Comments) || null,
            reposts: parseInt(row.Reposts) || null,
            views: parseInt(row.Views) || null,
            impressions: parseInt(row["Impressions (owned posts)"]) || null,
            reach: parseInt(row["Reach (owned posts)"]) || null,
            saves: parseInt(row.Saves) || null,
            potential_reach: parseInt(row["Potential reach"]) || null,
