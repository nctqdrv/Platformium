      ...
      for (const row of excelData) {
        try {
          ...
          const dataToInsert = {
            ...
            publication_place_subscribers: row["Publication place subscribers"] || null,
            ...
            wow: row.Wow || null,
            sad: row.Sad || null,
            angry: row.Angry || null,
            care: row.Care || null,
            dislikes: row.Dislikes || null,
            comments: row.Comments || null,
            reposts: row.Reposts || null,
            views: row.Views || null,
            impressions_owned_posts: row["Impressions (owned posts)"] || null,
            reach_owned_posts: row["Reach (owned posts)"] || null,
            saves: row.Saves || null,
            potential_reach: row["Potential reach"] || null,
